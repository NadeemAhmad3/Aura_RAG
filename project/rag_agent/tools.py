    ...
    def _search_child_chunks(self, query: str, limit: int) -> str:
        ...
        try:
            ...
            return "\n\n".join([
                ...
                f"File Name: {os.path.basename(doc.metadata.get('source', ''))}\n"
    ...
    def _retrieve_many_parent_chunks(self, parent_ids: List[str]) -> str:
        ...
        try:
            ...
            return "\n\n".join([
                ...
                f"File Name: {os.path.basename(doc.get('metadata', {}).get('source', 'unknown'))}\n"
    ...
    def _retrieve_parent_chunks(self, parent_id: str) -> str:
        ...
        try:
            ...
            return (
                ...
                f"File Name: {os.path.basename(parent.get('metadata', {}).get('source', 'unknown'))}\n"
